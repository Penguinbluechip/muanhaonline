...
<?php echo $this->Form->create('Need');?>
	<fieldset>
		<legend><?php __('Sửa thông tin nhu cầu'); ?></legend>
	<?php
	...
	<div class="input text required">
		<label for="NeedFor"><?php echo __('Hình thức'); ?></label>
			<table id="NeedNeedTypes" style="width:200px">				    
				<tbody>	
					<?php
					...
					?>
						<td style="font-weight: normal">
							<input <?php echo $checked ?> type="checkbox" id="NeedFor" maxlength="255" name="data[Need][for][<?php echo $f[0] ?>]">
							<?php echo $f[1] ?>
						</td>
					<?php
						if($k%3 == 2) echo '</tr>';
	...
	<div id="utility_contain" class="input text required">
		...
		<table id="NeedDistrictsTable">				    
			...
			<div id="utility_contain" class="input text required">
				...
				từ
				<input type="text" id="NeedPriceFrom" maxlength="255" value="<?php echo number_format($this->data['Need']['price_from'], 0, '.', ','); ?>" name="data[Need][price_from]">
				đến
				<input type="text" id="NeedPriceTo" maxlength="255" value="<?php echo number_format($this->data['Need']['price_to'], 0, '.', ','); ?>" name="data[Need][price_to]">
			</div>
...
<?php echo $this->Form->end(__('Lưu thông tin', true));?>
</div>
<div class="actions">
