...
<?php echo $this->Form->create('Need');?>
	...
	<div class="input text required">
		<label for="NeedFor"><?php echo __('Hình thức'); ?></label>
			<table id="NeedNeedTypes" style="width:200px">				    
				<tbody>	
					<?php
						$fors = array(array("b", __('Mua', true)),array("r", __('Thuê', true)));	
						foreach($fors as $k => $f) {
	...
	<?php
		...
		echo $this->Form->input('guest_name', array('label'=>'Tên'));
			echo $this->Form->input('guest_phone', array('label'=>'Số điện thoại'));
			echo $this->Form->input('guest_email', array('label'=>'Email'));
	?>
	</fieldset>
