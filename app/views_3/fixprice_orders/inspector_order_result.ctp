  ...
  var infowindow;
	...
	function updateForm(position)
	{
		...
		<div class="breadcrumb">
			<?php
				...
				$breads[] = array('link'=>$this->Html->url(array('controller'=>'products', 'action'=>'reset')), 'title'=>'Yêu cầu thẩm định BĐS');
	...
	<div id="bottom-content" class="clear">	
		...
		<div class="left-content" style="width:100%">
			...
			<br />
			<h2 class="fix_heading" style="clear: both;padding-top: 20px;">Kết quả thẩm định</h2>
			<div class="motabds">
				<?php if($fixprice_order['FixpriceAnswer']['price_total'] != '') { ?>
					<ul>	
						...
						<li style="width:100% !important" class="gtable"><strong>Thông tin TSSS:</strong> <br />
							...
							<?php //echo $fixprice_order['FixpriceAnswer']['relate_items']; ?>
