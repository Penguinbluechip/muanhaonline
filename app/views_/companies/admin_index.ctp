<div class="companies index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('company_category_id');?></th>
	...
	<tr<?php echo $class;?>>
		<td>
			<?php echo $this->Html->image("/uploads/company_image/filename/thumb/admin/".$company["CompanyImage"]["filename"], array('title' => $company["CompanyImage"]["title"])); ?>
		</td>
		<td><?php echo $company['Company']['name']; ?>&nbsp;</td>
		<td>
			<?php echo $company['CompanyCategory']['name']; ?>
		</td>
