	...
	<div id="bottom-content" class="clear">
		...
		<?php echo $this->element('checkoutline'); ?>
                ...
                <div class="thongtincanho">
                            Cám ơn quý khách hàng đã đăng ký dịch vụ của chúng tôi. Thông tin dịch vụ và thông tin thanh toán chúng tôi sẽ thông báo trực tiếp đến email của quý khách (<?php echo $fixprice_order['FixpriceCustomer']['email'] ?>).
                            <br />
