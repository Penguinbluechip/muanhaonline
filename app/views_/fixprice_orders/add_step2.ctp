...
<?php echo $this->Form->create('Product', array('type' => 'file', 'url' => array('controller' => 'fixprice_orders', 'action' => 'add_step2')));?>
	...
	<div id="tabs-2">	
			...
			<div class="input text" id="gtable_contain">
				<label for="ProductsUtility"><?php echo __('Bảng thông tin thu thập<br />(tùy chọn; đơn vị: m)'); ?></label>
				<br />
	...
	<div id="tabs-3">
			...
			<div><strong>(Tải hình ảnh - tập tin ảnh JPG/PNG không quá 2MB)</strong></div>
						...
						<input type="text" id="ProductImageTitle" name="data[ProductImage][0][title]" placeholder="Tiêu đề ảnh" />
					...
					<div class="input file">
						<label for="ProductImageFilename">Tập tin ảnh</label>
						<input type="text" id="ProductImageTitle" name="data[ProductImage][1][title]" placeholder="Tiêu đề ảnh" />
					...
					<div class="input file">
						<label for="ProductImageFilename">Tập tin ảnh</label>
						<input type="text" id="ProductImageTitle" name="data[ProductImage][2][title]" placeholder="Tiêu đề ảnh" />
...
{
	$('.tab_detail_head2').css('background', 'none repeat scroll 0 0 red');
}

if($('#tabs-1').find(".error-message").size())
{
	$('.tab_detail_head1').css('background', 'none repeat scroll 0 0 red');
}
