...
<body>
	<div id="container">
		<div id="header">
			<h1 style="float:left">
				<?php if (!empty($user)) { echo $group["Group"]["name"].": "; }?>				
					...
					<div class="" style="float:left">
						...
						<ul>
							<li <?php if(($this->params['controller'] == 'projects')) echo ' class="activelink"'; ?>>
								<?php echo $this->Html->link(__('Dự án', true), array('controller' => 'projects', 'action' => 'index', 'manager'=>true)); ?></li>
							<li <?php if(($this->params['controller'] == 'products')) echo ' class="activelink"'; ?>>
								<?php echo $this->Html->link(__('Bất động sản', true), array('controller' => 'products', 'action' => 'index', 'manager'=>true)); ?></li>
							<li <?php if(($this->params['controller'] == 'favorites')) echo ' class="activelink"'; ?>>
								<?php echo $this->Html->link(__('Tin lưu trữ', true), array('controller' => 'favorites', 'action' => 'index', 'manager'=>true)); ?></li>
							<li <?php if(($this->params['controller'] == 'customers')) echo ' class="activelink"'; ?>>
								<?php echo $this->Html->link(__('Khách hàng liên hệ', true), array('controller' => 'customers', 'action' => 'index', 'manager'=>true)); ?></li>
							<li <?php if(($this->params['controller'] == 'needs')) echo ' class="activelink"'; ?>>
								<?php echo $this->Html->link(__('Nhu cầu', true), array('controller' => 'needs', 'action' => 'index', 'manager'=>true)); ?></li>
							<li <?php if(($this->params['controller'] == 'fixprice_orders')) echo ' class="activelink"'; ?>>
								<?php echo $this->Html->link(__('Yêu cầu thầm định', true), array('controller' => 'fixprice_orders', 'action' => 'index', 'manager'=>true)); ?></li>
						</ul>
					</div>
				<?php } ?>
				<!--
