 ...
 */
	Configure::write('Routing.prefixes', array('admin', 'manager', 'user', 'expert', 'supervisor', 'inspector'));
 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qoittxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859365457453542496749683645');
