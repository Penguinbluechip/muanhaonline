...
<h2 style="clear:both"><?php __('Đăng tin bất động sản');?></h2>
...
<table>
	...
	<div id="tabs-1">
		...
		<?php
			...
			?>
				...
				<div class="input text required">
					<div class="facade_input"><input type="radio" id="ProductFacade" name="data[Product][facade]" value="Hẻm" checked="checked" /> Hẻm</div>
					<div class="facade_input"><input type="radio" id="ProductFacade" name="data[Product][facade]" value="Mặt tiền" /> Mặt tiền</div>						
				</div>
	...
	<div id="tabs-2">	
		<table><tr>
			...
			echo $this->Form->input('create_date', array('label'=>'Ngày tạo(tháng-ngày-năm)','monthNames' => false));
		...
		<td>
			...
			<div class="meta">
				<?php echo $this->Form->input('meta_keywords', array('label'=>'Từ khóa', "type"=>"text")); ?>
				(Nhập từ khóa để google tìm thấy sản phẩm của bạn)
	...
	<div style="display: none">
		  <?php echo $this->element('whoisonline'); ?>
				...
				<div class="submit_buts">
				    ...
				    <?php echo $form->submit('Đăng tin', array('name'=>'postnew', 'onclick'=>"this.form.target='_self';return true;")); ?>
