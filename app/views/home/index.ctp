				...
				<div class="featured-content">
					...
					<div class="content">
						<div class="home_top_content">
							<h2 onclick="window.location='<?php echo $this->Html->url(array('controller'=>'products', 'action'=>'details',
													     'city'=>strtolower(Inflector::slug($item["City"]["name"])),
													     'id'=>$item["Product"]["id"],
													     'name'=>strtolower(Inflector::slug($item["Product"]["name"])))) ?>';" style="cursor: pointer"><?php echo $item["Product"]["name"]; ?></h2>
		...
		<div class="sidebar">
			...
			<div class="video clear">
				...
				<ul>
					...
					<li><a href="#kepler"><img src="img/partner/kepler.png" alt="" /></a></li>
