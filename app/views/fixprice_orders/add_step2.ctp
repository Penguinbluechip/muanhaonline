...
<?php echo $this->Form->create('Product', array('type' => 'file', 'url' => array('controller' => 'fixprice_orders', 'action' => 'add_step2')));?>
	...
	<div id="tabs-3" class="<?php if(true) echo "error-tabs"; ?>">
		<div class="pdescription">
			...
			<p>Để đảm bảo hình ảnh đầy đủ và khách quan, bạn phải nhập đủ 3 ảnh của bất động sản bao gồm: hình ảnh bất động sản (nhìn chính diện từ bên ngoài), hình ảnh bên trong bất động sản, đường(hẻm) trước nhà.</p>
