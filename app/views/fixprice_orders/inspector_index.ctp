	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php if($fixpriceOrder['FixpriceOrderState']['alias'] == 'EXPERT_PENDING') { ?>
				...
				<?php if($fixpriceOrder['FixpriceOrder']['countinvalid'] < 1) echo $this->Html->link(__('Không duyệt', true), '#invalid_box', array('class'=>'fancybox_link', 'onmouseover'=>'$("#invalid_box #FixpriceOrderId").attr("value", "' .$fixpriceOrder['FixpriceOrder']['id']. '")')); ?>
