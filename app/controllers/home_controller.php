...
class HomeController extends AppController {
	...
	var $name = 'Home';
		...
		$specialProducts[$key]["Product"]["name"] = $this->Product->getProductTitle($p);
		...
		$topProducts[$key]["Product"]["name"] = $this->Product->getProductTitle($p);
		...
		$salesProducts[$key]["Product"]["sname"] = $this->Product->getProductTitle($p);
		...
		$leasingProducts[$key]["Product"]["sname"] = $this->Product->getProductTitle($p);
		...
		$newProducts[$key]["Product"]["sname"] = $this->Product->getProductTitle($p);
