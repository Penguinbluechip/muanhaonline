...
class AppController extends Controller {
  public $components = array(
    ...
    'Auth' => array(
      ...
      'authError' => 'Bạn không thể truy xuất được phần này. Vui lòng đăng nhập hoặc đăng ký để sử dụng dịch vụ'
    ),
  'Session',
  'SwiftMailer',
  'RequestHandler'
  ...
  public function beforeRender() {
    ...
    //$this->FixpriceOrder->updateState($state = 0);
    
    //$this->online_render();
    
    //$this->set('page_title', 'MuaNhaOnline.vn - Trang chủ');
  }
