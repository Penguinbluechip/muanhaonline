			...
			<div class="search">
				...
				<form method="post" action="#">
                    ...
                    <option value="0">- <?php echo __("Dự án"); ?> -</option>
						...
						<li class="buttons clear"><a href="#" onclick="$('#filter').submit();"><span>Tìm kiếm</span></a> <a href="#?w=409" rel="advance-search" class="poplight"><span>Tìm kiếm nâng cao</span></a></li>
					</ul>
				</form>
			</div>
