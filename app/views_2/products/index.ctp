  ...
  <span>Xem chi tiết</span>
	...
	?>
				...
				<div style="float: right; margin-top: 10px;">
					<input type="text" name="page" id="pagenum" style="width: 30px; text-align: right" />
					<input type="button" name="page" value="Chuyển trang" onclick="if($('#pagenum').val()) document.location = '/products/index/page:'+$('#pagenum').val()" />
				</div>
