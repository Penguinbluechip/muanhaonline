<div class="fixpriceTypes view">
<h2><?php  __('Fixprice Type');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $fixpriceType['FixpriceType']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Name'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $fixpriceType['FixpriceType']['name']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Description'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $fixpriceType['FixpriceType']['description']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Fixprice Type', true), array('action' => 'edit', $fixpriceType['FixpriceType']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Fixprice Type', true), array('action' => 'delete', $fixpriceType['FixpriceType']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $fixpriceType['FixpriceType']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($fixpriceType['FixpriceOrder'])):?>
	...
	<?php
		$i = 0;
		foreach ($fixpriceType['FixpriceOrder'] as $fixpriceOrder):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
